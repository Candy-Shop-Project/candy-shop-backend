...
from .views import product_list, add_product, delete_product, update_product, add_category, individual_product, search_product, get_multiple_products, create_payment_intent
...
urlpatterns = [
    ...
    path('create_payment_intent/', create_payment_intent, name='create_payment_intent'), # stripe view
]